...
CREATE TABLE `AssignmentGrade` (
  ...
  UNIQUE KEY `ai_sectionUserId_unq_idx` (`SectionUserID`, `AssignmentInstanceID`),
  FOREIGN KEY (`SectionUserID`) REFERENCES `SectionUser` (`SectionUserID`) ON DELETE NO ACTION ON UPDATE CASCADE,
...
CREATE TABLE `WorkflowGrade` (
  ...
  UNIQUE KEY `wf_sectionUserId_unq_idx` (`SectionUserID`, `WorkflowActivityID`),
  FOREIGN KEY (`SectionUserID`) REFERENCES `SectionUser` (`SectionUserID`) ON DELETE NO ACTION ON UPDATE CASCADE,
...
CREATE TABLE `TaskGrade` (
  ...
  UNIQUE KEY `ti_sectionUserId_unq_idx` (`SectionUserID`, `TaskInstanceID`),
  FOREIGN KEY (`SectionUserID`) REFERENCES `SectionUser` (`SectionUserID`) ON DELETE NO ACTION ON UPDATE CASCADE,
  FOREIGN KEY (`WorkflowActivityID`) REFERENCES `WorkflowActivity` (`WorkflowActivityID`) ON DELETE NO ACTION ON UPDATE CASCADE,
