...
--
-- Dumping data for table `TaskSimpleGrade`
--

LOCK TABLES `TaskSimpleGrade` WRITE;
/*!40000 ALTER TABLE `TaskSimpleGrade` DISABLE KEYS */;
/*!40000 ALTER TABLE `TaskSimpleGrade` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `User` VALUES (1,'ajr42','Alan','Romano','J',NULL,1,1);
...
INSERT INTO `UserContact` VALUES (1,'ajr42@njit.edu','(675) 234-4853','Al','Romano','alRom',NULL,NULL);
...
INSERT INTO `UserLogin` VALUES (1,'ajr42@njit.edu','$argon2i$v=19$m=16384,t=4,p=2$Tj62RffkwTjPJcF4CfaMfVJMG+dZzn0HhS61kVGqUISDETt7OQmujQQHf5BJvPkwd/tszl1cB5eOMKWXp+l0nQ$sfHMd07iNX8HC8WYg5ukUqpjzhaKAr2MMxW+P1IjZzO1Mjcp5r4t2FpKaCii2X+QpLk66SdfpxLLPxO3gZs/bg',NULL,NULL,NULL,NULL);
...
--
-- Dumping data for table `VolunteerPool`
--

LOCK TABLES `VolunteerPool` WRITE;
/*!40000 ALTER TABLE `VolunteerPool` DISABLE KEYS */;
/*!40000 ALTER TABLE `VolunteerPool` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `WorkflowGrade`
--

LOCK TABLES `WorkflowGrade` WRITE;
/*!40000 ALTER TABLE `WorkflowGrade` DISABLE KEYS */;
/*!40000 ALTER TABLE `WorkflowGrade` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2017-05-16 22:14:08
